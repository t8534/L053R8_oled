...
#define OLED_DC_RESET		HAL_GPIO_WritePin(GPIOC, OLED_DC_Pin, GPIO_PIN_RESET)
#define OLED_DC_SET			HAL_GPIO_WritePin(GPIOC, OLED_DC_Pin, GPIO_PIN_SET)

#define OLED_RST_RESET		HAL_GPIO_WritePin(GPIOC, OLED_RES_Pin, GPIO_PIN_RESET)
#define OLED_RST_SET		HAL_GPIO_WritePin(GPIOC, OLED_RES_Pin, GPIO_PIN_SET)
